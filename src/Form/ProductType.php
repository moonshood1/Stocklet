...
class ProductType extends ApplicationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('spec1', TextareaType::class, $this->getConfiguration("Description Spec 1",""))
            ->add('spec1Title',TextType::class,$this->getConfiguration("Titre Spec 1",""))
            ->add('spec2', TextareaType::class, $this->getConfiguration("Description Spec 2",""))
            ->add('spec2Title',TextType::class,$this->getConfiguration("Titre Spec 2",""))
            ->add('spec3', TextareaType::class, $this->getConfiguration("Description Spec 3",""))
            ->add('spec3Title',TextType::class,$this->getConfiguration("Titre Spec 3",""))
            ...
            ->add('rightPic1Url', UrlType::class,$this->getConfiguration("Url de l'image 1",""))
            ->add('rightPic2Url', UrlType::class,$this->getConfiguration("Url de l'image 2",""))
            ->add('rightPic3Url', UrlType::class,$this->getConfiguration("Url de l'image 3",""))
            ->add('rightPic4Url', UrlType::class,$this->getConfiguration("Url de l'image 4",""))
            ->add('rightPic5Url', UrlType::class,$this->getConfiguration("Url de l'image 5",""))
            ...
            ->add('rightPic1File', FileType::class,$this->getConfiguration("Upload de l'image de droite 1",""),['required'=> false])
            ->add('rightPic2File', FileType::class,$this->getConfiguration("Upload de l'image de droite 2",""),['required'=> false])
            ->add('rightPic3File', FileType::class,$this->getConfiguration("Upload de l'image de droite 3",""),['required'=> false])
            ->add('rightPic4File', FileType::class,$this->getConfiguration("Upload de l'image de droite 4",""),['required'=> false])
            ->add('rightPic5File', FileType::class,$this->getConfiguration("Upload de l'image de droite 5",""),['required'=> false])
